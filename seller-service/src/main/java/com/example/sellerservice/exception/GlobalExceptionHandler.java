...
public class GlobalExceptionHandler {
    ...
    ResponseEntity<ErrorResponse> handleSeller(SellerServiceException exception, HttpServletRequest request) {
    ...
    ResponseEntity<ErrorResponse> handleConflict(HttpServletRequest request) {
        return response(ErrorCode.SELLER_DATA_CONFLICT, request);
    }
